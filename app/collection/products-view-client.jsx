...
//           p._vendor.includes(v.toLowerCase().trim())
//         )
//       );
//     }
...
//                 {/* <h3 className="font-semibold text-[#7d4b0e] mb-4">Category</h3> */}
//                 {/* <select
//                   value={category}
//                   onChange={(e) => setCategory(e.target.value)}
//                   className="w-full border p-3 rounded-lg text-[#7d4b0e]"
//                 >
...
//                 <h3 className="font-semibold text-[#7d4b0e] mb-4 mt-8">Price Range</h3>
...
//                       {/* Active range */}
//                       <div
//                         className="absolute h-2 bg-amber-500 rounded-lg top-2"
//                         style={{
...
//                 <h3 className="font-semibold text-[#7d4b0e] mb-4 mt-8">Variant Options</h3>
...
//                           );
//                         }}
//                         className="w-4 h-4 text-[#7d4b0e] rounded"
//                       />
...
//                 {/* <h3 className="font-semibold text-[#7d4b0e] mb-4 mt-8">Tags</h3> */}
//                 {/* <div className="space-y-3 max-h-60 overflow-y-auto">
//                   {tags.map((tag) => (
...
//                 <h3 className="font-semibold text-[#7d4b0e] mb-4 mt-8">Vendors</h3>
//                 <div className="space-y-3 max-h-60 overflow-y-auto">
//                   {vendors.map((vendor) => (
...
//                 {/* <h3 className="font-semibold text-[#7d4b0e] mb-4 mt-8">Product Types</h3> */}
//                 <div className="space-y-3 max-h-60 overflow-y-auto">
...
//                   }}
//                   className="w-full bg-[#7d4b0e] text-white py-3 rounded-lg font-semibold hover:bg-[#6b400c] transition mt-8 cursor-pointer"
//                 >
//                   Clear All Filters
//                 </button>
//               </div>
...
//                       {/* <p className="text-xl text-[#7d4b0e]">
...
//                           router.push("/collection");
//                         }}
//                         className="mt-3 text-[#7d4b0e] underline hover:no-underline cursor-pointer"
//                       >
//                         Clear search
//                       </button>
//                     </div>
...
//                     className="border p-2 rounded-lg text-[#7d4b0e]"
//                   >
...
//                     className={`p-2 border rounded-lg cursor-pointer ${gridType === "grid2" ? "bg-[#7d4b0e] text-white" : "text-[#7d4b0e]"
//                       }`}
//                   >
//                     <LayoutGrid size={18} />
//                   </button>
...
//                     className={`p-2 border rounded-lg cursor-pointer ${gridType === "grid3" ? "bg-[#7d4b0e] text-white" : "text-[#7d4b0e]"
//                       }`}
//                   >
//                     <Grid size={18} />
//                   </button>
...
//                     className={`p-2 border rounded-lg cursor-pointer ${gridType === "grid4" ? "bg-[#7d4b0e] text-white" : "text-[#7d4b0e]"
//                       }`}
//                   >
...
//                     className={`p-2 border rounded-lg cursor-pointer ${gridType === "list" ? "bg-[#7d4b0e] text-white" : "text-[#7d4b0e]"
//                       }`}
//                   >
//                     <List size={18} />
//                   </button> */}
...
//                       setPriceRange([minMaxPrice.min, minMaxPrice.max]);
//                     }}
//                     className="mt-4 text-[#7d4b0e] underline font-medium cursor-pointer"
//                   >
//                     Clear all filters
//                   </button>
//                 </div>
