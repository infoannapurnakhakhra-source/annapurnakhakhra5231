...
// //                     <Truck size={16} className="text-[#7d4b0e]" />
// //                     Free Shipping on orders over ₹500
// //                   </span>
// //                   <span className="text-xs font-semibold text-[#7d4b0e]">
// //                     {isFreeDelivery
// //                       ? "Unlocked! 🎉"
...
// //                   <div
// //                     className={`h-full rounded-full transition-all duration-700 ease-out ${isFreeDelivery ? 'bg-green-500' : 'bg-amber-500'
// //                       }`}
...
// //                         className="text-red-500 hover:text-red-700 hover:bg-red-50 rounded-lg p-2 transition-colors self-end sm:self-start flex-shrink-0"
// //                       >
// //                         <Trash2 size={20} />
// //                       </button>
// //                     </div>
...
// //                   className="w-full bg-gradient-to-r from-[#8f4a12] to-[#5a3102]
...
// //                     className="flex-1 px-6 py-4 border-2 border-gray-300 rounded-lg font-semibold text-gray-700 hover:bg-gray-50 transition-colors"
// //                   >
// //                     Back to Cart
// //                   </button>
// //                   <button
// //                     onClick={sendOTP}
// //                     disabled={!email}
// //                     className="flex-1 px-6 py-4 bg-gradient-to-r from-[#8f4a12] to-[#5a3102] text-white rounded-lg font-bold hover:shadow-lg transition-all disabled:opacity-50 disabled:cursor-not-allowed"
// //                   >
// //                     Continue
// //                   </button>
// //                 </div>
...
// //                       className="w-full mt-6 px-6 py-4 bg-amber-100 text-[#7d4b0e] rounded-lg font-bold hover:bg-amber-200 transition-all flex items-center justify-center gap-2 disabled:opacity-50 text-lg"
// //                     >
// //                       {isCalculating ? (
// //                         <>
...
// //                     <button
// //                       onClick={handleBackToCart}
// //                       className="flex-1 px-8 py-4 border-2 border-gray-300 rounded-lg font-bold text-gray-700 hover:bg-gray-50 transition-colors text-lg"
// //                     >
// //                       Back to Cart
// //                     </button>
// //                     <button
...
// //                       className="flex-1 px-8 py-4 bg-gradient-to-r from-[#8f4a12] to-[#5a3102] text-white rounded-lg font-bold hover:shadow-xl transition-all disabled:opacity-50 disabled:cursor-not-allowed text-lg"
// //                     >
// //                       Place Order
// //                     </button>
// //                   </div>
...
//           variant_title:
//             node.merchandise.title !== "Default Title" ? node.merchandise.title : null,
...
"use client";
import { useEffect, useState } from "react";
import { X, MapPin, CreditCard, Truck, Wallet, CheckCircle, Mail, ShieldCheck, Loader2, RefreshCw, Plus, Minus, Trash2, Calculator, ShoppingCart, Smartphone } from 'lucide-react';
...
export default function CartPage() {
  ...
  // Checkout States - UPDATED: Added phone and login_phone/login_otp steps
  ...
  const fetchUserProfile = async () => {
    ...
    console.log("🚀 CART PAGE - Fetching profile for customerShopifyId:", customerId);
    setAddressLoading(true);
            ...
            <div className="p-6 md:p-8">
              <div className="max-w-md mx-auto">
                <div className="mb-6">
                  <div className="flex items-center gap-3 mb-4">
                    <div className="w-12 h-12 bg-amber-100 rounded-full flex items-center justify-center">
                      <Smartphone size={24} className="text-[#7d4b0e]" />
                    </div>
                    <h4 className="text-xl font-bold text-gray-900">Mobile Number</h4>
                  </div>
                  <input
                    type="tel"
                    inputMode="numeric"
                    ...
                    className="w-full px-4 py-4 border-2 border-gray-200 rounded-lg text-lg focus:border-[#7d4b0e] focus:outline-none transition-colors"
                  />
              ...
              <div className="max-w-md mx-auto">
                ...
                <div className="mb-6">
                  <div className="flex items-center gap-3 mb-4">
                    ...
                    <h4 className="text-xl font-bold text-gray-900">Enter OTP</h4>
                  </div>
                  <input
                    type="text"
                    inputMode="numeric"
                    ...
                    className="w-full px-4 py-4 border-2 border-gray-200 rounded-lg text-center text-2xl tracking-widest font-bold focus:border-[#7d4b0e] focus:outline-none transition-colors"
                  />
                </div>
                <div className="flex gap-3">
                  <button
                ...
                <div className="max-w-4xl mx-auto space-y-6">
                    ...
                    <div className="grid md:grid-cols-2 gap-4">
                      ...
                      <div className="md:col-span-2">
                        ...
                        <input
                          ...
                          className={`w-full px-4 py-3 rounded-lg focus:outline-none transition-colors ${emailError && emailTouched
                            ? "border-2 border-red-500 bg-white focus:border-red-500"
                            : "border-2 border-gray-200 focus:border-[#7d4b0e]"
                            }`}
                  ...
                  <div className="flex gap-4 pt-4">
                    ...
                    <button
                      ...
                      className="flex-1 px-8 py-4 bg-gradient-to-r from-[#8f4a12] to-[#5a3102] text-white rounded-lg font-bold hover:shadow-xl transition-all disabled:opacity-50 disabled:cursor-not-allowed text-lg flex items-center justify-center gap-2 cursor-pointer"
                    >
                      {isPlacingOrder ? (
                        <>
                          <svg
